              ...
              {/* <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel"> */}
                {/* <div class="carousel-inner"> */}
                  {/* <div class="carousel-item active">
                     <img class="d-block w-100" src="https://images.pexels.com/photos/220201/pexels-photo-220201.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="First slide" style={{height: "500px"}}/>
                  </div>
                  <div class="carousel-item">
                     <img class="d-block w-100 " src="https://images.pexels.com/photos/235648/pexels-photo-235648.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Second slide" style={{height:"500px"}}/>
                  </div> */}
                  <div class="">
                     <img class="d-block w-100 " src="https://img.freepik.com/free-vector/time-travel-vector-flyer-with-white-copy-space-sky-with-airplane_134830-1061.jpg?size=626&ext=jpg" alt="Second slide" style={{height:"500px"}}/>
                  </div>
                  {/* <div class="carousel-item">
                     <img class="d-block w-100 " src="https://images.pexels.com/photos/45853/grey-crowned-crane-bird-crane-animal-45853.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Second slide" style={{height:"500px"}}/>
                  </div> */}
                  {/* <div class="carousel-item">
    ...
    <section class="bg-light mt-5" id="tourist">    
     <div class="container">
        ...
        <div class="col-md-4">
          <div class="testimonial mb-5">
           <div class="avatar mx-auto">
            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(1).jpg" class="rounded-circle z-depth-1 img-fluid" alt="places"/>
          </div>
      ...
      <div class="col-md-4">
        <div class="testimonial mb-5">
          <div class="avatar mx-auto">
            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(8).jpg" class="rounded-circle z-depth-1 img-fluid" alt="places"/>
          </div>
      ...
      <div class="col-md-4">
        <div class="testimonial mb-5">
          <div class="avatar mx-auto">
            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(10).jpg" class="rounded-circle z-depth-1 img-fluid" alt="places"/>
          </div>
